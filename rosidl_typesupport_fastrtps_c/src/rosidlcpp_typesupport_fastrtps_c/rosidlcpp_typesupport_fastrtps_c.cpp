...
GeneratorTypesupportFastrtpsC::GeneratorTypesupportFastrtpsC(const rosidlcpp_core::GeneratorArguments& generator_arguments) : GeneratorBase(), m_arguments(generator_arguments) {
